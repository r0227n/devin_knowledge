...
void main() {
  group('DevinClient', () {
    ...
    test(
      'Knowledge service - listKnowledge returns a paginated list of knowledge items',
      () async {
    ...
    test(
      'Knowledge service - getKnowledge returns a knowledge item by ID',
      () async {
    ...
    test(
      'Knowledge service - createKnowledge creates a new knowledge item',
      () async {
    ...
    test(
      'Secret service - listSecrets returns a paginated list of secrets',
      () async {
